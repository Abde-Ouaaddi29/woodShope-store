...
function ProductDetails() {
  ...
  const showProduct = async () => {
    try {
      ...
      if (!response) {
        setMessage("sorry ! no product with this id.");
      }
    } catch (error) {
      console.error(error);
  ...
  const showCtegory = async () => {
    try {
      const response = await ShowCategory(product.category.id);
      console.log(response);
  ...
  return (
    <section key={product.id} className="container mt-10">
        ...
        <div className="lg:max-w-[50%] lg:py-5 max-w-[100%] pl-4">
          ...
          <div className="mt-2">
            ...
            <div className="mt-2">
              <span>
                Category:{" "}
                <a className="text-semi-black hover:text-primary" href="#">
                  {product.category?.name}
                </a>
              </span>
            </div>
  ...
  //                   Features
  //                 </h3>
  //                 <p className="mb-5">{product.features}</p>
  //               </div>
  //               <div>
  //                 <ul>
  ...
  //                       height="20"
  //                       fill="#000000"
  //                       className="bi bi-check2 font-bold"
  //                       viewBox="0 0 16 16"
  //                     >
  //                       <path d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0" />
  //                     </svg>
  //                     <li className="ml-4">{product.features}</li>
  //                   </div>
  //                 </ul>
  //               </div>
  //             </div>
